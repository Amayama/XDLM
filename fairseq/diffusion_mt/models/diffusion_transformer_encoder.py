...
class DiffusionTransformerEncoderBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens):
        ...
        # print("embed_tokens is {}".format(embed_tokens))
        self.dropout_module = FairseqDropout(
        ...
        if self.concat_pe:
            self.pe_fusion_ffn = nn.Linear(3 * cfg.encoder.embed_dim, cfg.encoder.embed_dim)
    ...
    def forward_embedding(
        self, src_tokens, src_position_emb,src_language_emb,token_embedding: Optional[torch.Tensor] = None
    ):
    ...
    def forward(
        ...
        return self.forward_scriptable(
            src_tokens,src_position_emb,src_language_emb,src_lengths, return_all_hiddens, token_embeddings
        )
    ...
    def forward_scriptable(
        ...
        x, encoder_embedding = self.forward_embedding(src_tokens,src_position_emb,src_language_emb.long(),token_embeddings)
