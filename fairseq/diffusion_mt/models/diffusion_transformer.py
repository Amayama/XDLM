...
class DiffusionTransformerModel(FairseqNATModel):
    ...
    def _prepare_sample(self, sample, **kwargs):
        ...
        if self.args.q_sample_mode == "default":
            ...
            src_position_emb=sample['net_input']['src_position_emb'].repeat(num_q_samples,1)
            src_language_emb=sample['net_input']['src_language_emb'].repeat(num_q_samples,1)
        # encoding
