...
Proposed by Linyao, check the scripts below for details

#### Wiki-Monolingual

1. Use the script to download and get data by using Transformers
2. Preprocess the data

```
TEXT = wiki_en
fairseq-preprocess --joined-dictionary     --source-lang en     --trainpref $TEXT/train.src --validpref $TEXT/valid.src --testpref $TEXT/test.src     --destdir data-bin/wiki_en --thresholdtgt 0 --thresholdsrc 0  --srcdict $TEXT/dict.en.txt --only-source --workers 20
```
